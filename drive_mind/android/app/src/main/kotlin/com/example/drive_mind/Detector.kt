...
class Detector(
    ...
    fun detect(frame: Bitmap) {
        // Early exit if detector has been cleared
        if (isCleared) return
        ...
        try {
            ...
            // Double-check after getting interpreter
            if (isCleared) return
    ...
    private fun bestBox(array: FloatArray): List<BoundingBox>? {
        ...
        for (c in 0 until numElements) {
            ...
            if (maxConf > CONFIDENCE_THRESHOLD) {
                ...
                if (clsName.trim() in EXCLUDED_LABELS) continue
    ...
    companion object {
        ...
        // Labels to exclude from detection results
        private val EXCLUDED_LABELS = setOf("Road-divider", "pedestrian")
    }
}
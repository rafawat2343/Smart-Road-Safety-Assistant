...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String? _profileImageUrl; // Cloudinary URL
  ...
  // Load profile image from SharedPreferences and Firestore
  Future<void> _loadProfileImage() async {
    // First try to load from Firestore (Cloudinary URL)
    if (user != null) {
      try {
  ...
  // Save profile image to SharedPreferences (local backup)
  ...
  Future<void> _uploadToCloudinary(File imageFile) async {
    try {
      ...
      // Also save base64 locally as backup
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Profile picture uploaded to cloud!"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_profileImageUrl != null || _profileImageBase64 != null)
                ListTile(
                  leading: const CircleAvatar(
